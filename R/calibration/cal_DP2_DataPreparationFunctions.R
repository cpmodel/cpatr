#-------------------------------------------------------------------------------
# Name:     DP4_DataPreparationFunctions2
# Purpose:  Script to build the data needed for the D matrix from 1990 onwards

# Change Log
# Version   Initials    Date        Change
# 0.1       DB          15-Feb-22   Creation: Gathering SJS' previous scripts
#-------------------------------------------------------------------------------


setwd(dirname(rstudioapi::getActiveDocumentContext()$path))

source('cal_DP1_DataPreparationConfig.R')
...
PrepareHistEC   <- function(InitYear  = StartYear,
                            FinYear   = EndYear){
